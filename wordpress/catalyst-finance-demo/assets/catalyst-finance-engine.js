(function (root, factory) {
  ...
  function validateScenario(scenario) {
    ...
    if (!scenario || scenario.contract_version !== CONTRACT_VERSION) issues.push('contract_version must be 1.9.0');
  ...
  function evaluate(inputPayload, generatedAt) {
    ...
    return {
      ...
      methodology: {
        model_id: MODEL_ID, model_version: '1.9.0', calculation_basis: 'annual_screening',
