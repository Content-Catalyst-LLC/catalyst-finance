"""Validated Catalyst Finance v2.0.0 contract records."""
...
METHODOLOGY_VERSION: Literal["2.0.0"] = "2.0.0"
...
class FinanceMethodology(ContractModel):
    model_id: Literal["catalyst-finance.screening"] = MODEL_ID
    model_version: Literal["2.0.0"] = METHODOLOGY_VERSION
...
class MigrationRecord(ContractModel):
    ...
    target_contract_version: Literal["2.0.0"] = CONTRACT_VERSION
...
class FinanceMetadata(ContractModel):
    ...
    version: Literal["2.0.0"] = CONTRACT_VERSION
    disclaimer: str
