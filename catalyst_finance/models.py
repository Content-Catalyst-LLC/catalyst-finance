"""Validated Catalyst Finance v1.3.0 contract records."""
...
class FinanceScenarioInput(ContractModel):
    contract_version: Literal["1.3.0"] = CONTRACT_VERSION
...
class FinanceMethodology(ContractModel):
    model_id: Literal["catalyst-finance.screening"] = MODEL_ID
    model_version: Literal["1.3.0"] = METHODOLOGY_VERSION
...
class MigrationRecord(ContractModel):
    ...
    target_contract_version: Literal["1.3.0"] = CONTRACT_VERSION
...
class FinanceMetadata(ContractModel):
    ...
    version: Literal["1.3.0"] = CONTRACT_VERSION
    disclaimer: str
