"""Demand, elasticity, pricing, and revenue contracts for v1.6.0."""
...
PRICING_CONTRACT_VERSION: Literal["1.6.0"] = "1.6.0"
...
class PricingDefinition(ContractModel):
    contract_version: Literal["1.6.0"] = PRICING_CONTRACT_VERSION
...
class PricingMethodology(ContractModel):
    model_id: Literal["catalyst-finance.pricing"] = PRICING_MODEL_ID
    model_version: Literal["1.6.0"] = PRICING_CONTRACT_VERSION
...
class PricingMetadata(ContractModel):
    generated_at: str
    version: Literal["1.6.0"] = PRICING_CONTRACT_VERSION
    grid_rows: int
