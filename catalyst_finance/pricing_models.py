"""Demand, elasticity, pricing, and revenue contracts for v2.0.0."""
...
PRICING_CONTRACT_VERSION: Literal["2.0.0"] = "2.0.0"
...
class PricingDefinition(ContractModel):
    contract_version: Literal["2.0.0"] = PRICING_CONTRACT_VERSION
...
class PricingMethodology(ContractModel):
    model_id: Literal["catalyst-finance.pricing"] = PRICING_MODEL_ID
    model_version: Literal["2.0.0"] = PRICING_CONTRACT_VERSION
...
class PricingMetadata(ContractModel):
    generated_at: str
    version: Literal["2.0.0"] = PRICING_CONTRACT_VERSION
    grid_rows: int
