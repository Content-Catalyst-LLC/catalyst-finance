"""Uncertainty, Monte Carlo, and stress-testing contracts for v1.5.0."""
...
UNCERTAINTY_CONTRACT_VERSION: Literal["1.5.0"] = "1.5.0"
...
class UncertaintyDefinition(ContractModel):
    contract_version: Literal["1.5.0"] = UNCERTAINTY_CONTRACT_VERSION
...
class UncertaintyMethodology(ContractModel):
    model_id: Literal["catalyst-finance.uncertainty"] = UNCERTAINTY_MODEL_ID
    model_version: Literal["1.5.0"] = UNCERTAINTY_CONTRACT_VERSION
...
class UncertaintyMetadata(ContractModel):
    generated_at: str
    version: Literal["1.5.0"] = UNCERTAINTY_CONTRACT_VERSION
