"""Uncertainty, Monte Carlo, and stress-testing contracts for v2.0.0."""
...
UNCERTAINTY_CONTRACT_VERSION: Literal["2.0.0"] = "2.0.0"
...
class UncertaintyDefinition(ContractModel):
    contract_version: Literal["2.0.0"] = UNCERTAINTY_CONTRACT_VERSION
...
class UncertaintyMethodology(ContractModel):
    model_id: Literal["catalyst-finance.uncertainty"] = UNCERTAINTY_MODEL_ID
    model_version: Literal["2.0.0"] = UNCERTAINTY_CONTRACT_VERSION
...
class UncertaintyMetadata(ContractModel):
    generated_at: str
    version: Literal["2.0.0"] = UNCERTAINTY_CONTRACT_VERSION
