"""Cost, budget, variance, and operating-economics contracts for v1.9.0."""
...
OPERATING_CONTRACT_VERSION: Literal["1.9.0"] = "1.9.0"
...
class OperatingDefinition(ContractModel):
    contract_version: Literal["1.9.0"] = OPERATING_CONTRACT_VERSION
...
class OperatingMethodology(ContractModel):
    model_id: Literal["catalyst-finance.operating"] = OPERATING_MODEL_ID
    model_version: Literal["1.9.0"] = OPERATING_CONTRACT_VERSION
...
class OperatingMetadata(ContractModel):
    generated_at: str
    version: Literal["1.9.0"] = OPERATING_CONTRACT_VERSION
    row_count: int
    unit_count: int
