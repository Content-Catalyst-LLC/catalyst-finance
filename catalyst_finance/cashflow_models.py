"""Typed cash-flow and capital-budgeting contracts for Catalyst Finance v2.0.0."""
...
CASHFLOW_CONTRACT_VERSION: Literal["2.0.0"] = "2.0.0"
...
class CashFlowScenarioInput(ContractModel):
    contract_version: Literal["2.0.0"] = CASHFLOW_CONTRACT_VERSION
...
class CashFlowMethodology(ContractModel):
    model_id: Literal["catalyst-finance.cash-flow"] = CASHFLOW_MODEL_ID
    model_version: Literal["2.0.0"] = CASHFLOW_CONTRACT_VERSION
...
class CashFlowMetadata(ContractModel):
    ...
    version: Literal["2.0.0"] = CASHFLOW_CONTRACT_VERSION
    disclaimer: str
