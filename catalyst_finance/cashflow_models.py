"""Typed cash-flow and capital-budgeting contracts for Catalyst Finance v1.3.0."""
...
CASHFLOW_CONTRACT_VERSION: Literal["1.3.0"] = "1.3.0"
...
class CashFlowScenarioInput(ContractModel):
    contract_version: Literal["1.3.0"] = CASHFLOW_CONTRACT_VERSION
...
class CashFlowMethodology(ContractModel):
    model_id: Literal["catalyst-finance.cash-flow"] = CASHFLOW_MODEL_ID
    model_version: Literal["1.3.0"] = CASHFLOW_CONTRACT_VERSION
...
class CashFlowMetadata(ContractModel):
    ...
    version: Literal["1.3.0"] = CASHFLOW_CONTRACT_VERSION
    disclaimer: str
