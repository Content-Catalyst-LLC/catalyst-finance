"""Scenario comparison, sensitivity, and threshold contracts for v1.8.0."""
...
COMPARISON_CONTRACT_VERSION: Literal["1.8.0"] = "1.8.0"
...
class ComparisonDefinition(ContractModel):
    contract_version: Literal["1.8.0"] = COMPARISON_CONTRACT_VERSION
...
class ComparisonMethodology(ContractModel):
    model_id: Literal["catalyst-finance.comparison"] = COMPARISON_MODEL_ID
    model_version: Literal["1.8.0"] = COMPARISON_CONTRACT_VERSION
...
class ComparisonMetadata(ContractModel):
    ...
    version: Literal["1.8.0"] = COMPARISON_CONTRACT_VERSION
    disclaimer: str
