...
Catalyst Finance v1.3.0 models cash flows from period 0 through a declared analysis horizon. Period 0 is undiscounted; later flows occur at the end of each selected monthly, quarterly, or annual period.
