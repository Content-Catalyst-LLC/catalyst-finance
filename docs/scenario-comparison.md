...
Catalyst Finance v1.6.0 compares complete cash-flow scenario revisions rather than untracked spreadsheet columns. Every alternative includes its workspace ID, scenario ID, revision ID, revision number, classification, cash-flow snapshot, and non-financial caveats.
